...
// Exported alongside generateQuestionArray so other callers (e.g.
// lib/keywordBankBuilder.js, which needs a JSON *object* back, not an array)
// can reuse the same Gemini call/retry plumbing instead of duplicating it.
module.exports = { generateQuestionArray, callGemini };
